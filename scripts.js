...
const buttonCalc = document.querySelector("#calc-btn");
...
// Função para alternar a exibição dos contêineres
...
[getHeight, getWeight].forEach((el) => {
...
buttonCalc.addEventListener("click", (e) => {
  ...
  const height = +getHeight.value.replace(",", ".");
  const weight = +getWeight.value.replace(",", ".");
